...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        songUL.innerHTML += `<li>
                        <img class="invert" src="public/svg/music.svg" alt="">
                        <div class="info">
                        ...
                        <div class="playNow">
                        <span>Play Now</span>
                        <img class="invert" src="public/svg/play.svg" alt="">
                        </div> </li>`;
    }
...
async function main() {
    ...
    await getSongs("public/songs/KaranAujla");
